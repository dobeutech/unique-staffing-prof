      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 700px; margin: 0 auto; padding: 20px;">
        <div style="background-color: #f4f4f4; padding: 30px; border-radius: 10px;">
          ...
          <div style="text-align: center; margin-top: 30px;">
            <a href="${req.headers.get('origin')}/admin/dashboard" style="background-color: #73B77D; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold;">View in Dashboard</a>
          </div>
        </div>
      </body>
      </html>
